...
const getIncomeByUserId = 'SELECT * FROM income WHERE userid = $1';
const createIncome = 'INSERT INTO income (userid, categoryid, amount, description, date) VALUES ($1, $2, $3, $4, $5) RETURNING *';
const updateIncome = 'UPDATE income SET categoryid = $1, amount = $2, description = $3, date = $4 WHERE id = $5 AND userid = $6';
const deleteIncome = 'DELETE FROM income WHERE id = $1 AND userid = $2 RETURNING *';
...
const createCategory = 'INSERT INTO categories (name, description) VALUES ($1, $2) RETURNING *';
