...
class ExpenseService {
  ...
  Future<String?> updateExpenseOfUser(Map<String, String> updateExpense, int expenseId) async {
  try {
  ...
  Future<String?> updateIncomeOfUser(Map<String, String> updateIncome, int incomeId) async {
  try {
    final response = await _dio.put(
      '/income/$incomeId',
      data: updateIncome,
